...
static asn_TYPE_member_t asn_MBR_ext1_16[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct EtsiTs102941DataContent__ext1, butterflyAuthorizationRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EtsiTs102941DataContent__ext1, butterflyAuthorizationResponse),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EtsiTs102941DataContent__ext1, butterflyCertificateRequest),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct EtsiTs102941DataContent__ext1, butterflyAtDownloadRequest),
...
static const asn_TYPE_tag2member_t asn_MAP_ext1_tag2el_16[] = {
    ...
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* butterflyAuthorizationResponse */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* butterflyCertificateRequest */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* butterflyCertificateResponse */
    { (ASN_TAG_CLASS_CONTEXT | (4 << 2)), 4, 0, 0 } /* butterflyAtDownloadRequest */
};
static asn_SEQUENCE_specifics_t asn_SPC_ext1_specs_16 = {
	sizeof(struct EtsiTs102941DataContent__ext1),
	offsetof(struct EtsiTs102941DataContent__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_EtsiTs102941DataContent_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct EtsiTs102941DataContent, choice.ext1),
		(ASN_TAG_CLASS_CONTEXT | (13 << 2)),
		0,
		&asn_DEF_ext1_16,
		0,
